...
<body>
    ...
    <div id="usual1" class="usual">
      <div id="tab2" class="tabson">
    	...
    	<ul class="seachform">
    	    <li><label>综合查询</label><input class="scinput" name="sysUser.userName"   placeholder="请输入用户姓名称或地址"/></li>
            <li><input name="" type="submit" class="scbtn" value="查询"/></li>
            <p:permissions right="addUser" >
           	 	<li class="clickk"><span><img src="<%=path%>/images/t01.png" /></span><a href="<%= basePath%>/biz/SysUser_openAdd.action" >添加</a></li>
            </p:permissions>
    ...
    <table class="tablelist">
        ...
        <td>
        	<p:permissions right="deleteUser">
	     		<a href="javascript:;" class="tablelinkdelete" id_value="${id}" userId="${userId}"> 删除</a>&nbsp;&nbsp;
	     	</p:permissions>
	     	<p:permissions right="editUser">
	        	<a href="<%= basePath%>/biz/SysUser_openEdit.action?id=${id}&userId=${userId}" class="tablelink">修改</a>
	        </p:permissions>
        </td>
        </p:permissions>
        </tr> 
